...
Navbar.propTypes= {ttile:PropTypes.string,
aboutText :PropTypes.string}
// is type  ke alawa kuch bheja to error 

// default props..in case i dont enter the value of props
Navbar.defaultProps={
    title: 'set title here',
    aboutText: 'About'
}

// then its compulsary to send props..undefined na ho
